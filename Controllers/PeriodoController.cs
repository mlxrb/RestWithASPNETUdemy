...
namespace RestWithASPNETUdemy.Controllers
{
    ...
    {
        private IPeriodoBusiness _periodoBusiness;

        public PeriodoController(IPeriodoBusiness periodoBusiness)
        {
            _periodoBusiness = periodoBusiness;
        }
        ...
        {
            var filial = _periodoBusiness.OrgStructureChildPeriodo(id);
        ...
        {
            var filial = _periodoBusiness.OrgStructurePeriodo(id);
            if (filial == null) return NotFound();
            return Ok(filial);
        }
        ...
        public IActionResult Post([FromBody] OrgUnitCreateDataVO uo)
        {
            ...
            return Ok(_periodoBusiness.CreateD2lPeriodo(uo));
        }
        ...
        {
            if (uo == null) return BadRequest();
            return Ok(_periodoBusiness.UpdateD2lPeriodo(id,uo));
        }
    }
}
